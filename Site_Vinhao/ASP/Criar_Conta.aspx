<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="Criar_Conta.aspx.cs" Inherits="Site_Vinhao.Criar_Conta" %>
...
<asp:TextBox ID="txDatadeNascimento" runat="server" TextMode="Date" placeholder="Data de Nascimento" TabIndex="3"></asp:TextBox>
    <asp:CompareValidator ID="validarDataNascimento" runat="server" ControlToValidate="txDatadeNascimento" ErrorMessage="Obrigatório" ForeColor="#FF3300" ValidationGroup="Validar"></asp:CompareValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Obrigatório" ControlToValidate="txDatadeNascimento" ForeColor="#FF3300" ValidationGroup="Validar"></asp:RequiredFieldValidator>
<br />
