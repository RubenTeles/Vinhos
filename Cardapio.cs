...
namespace Vinhao_Aplicacao
{
    public partial class Cardapio : Form
    {
        ...
        private void Carpario_Load(object sender, EventArgs e)
        {
            ...
            string numeroDeVinhosString = "";

            numeroDeVinhosString = "Tem " + numeroDeVinhos.ToString() + " Vinhos.";

            //int numeroDeUtilizadores = ;
            //string numeroDeUtilizadoresString = ;
            //numeroDeUtilizadoresString = "Tem " + numeroDeUtilizadores.ToString() + " Utilizadores.";
